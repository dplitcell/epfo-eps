...
<div align="center">
    ...
    <main>
        ...
        <form name="user"  action="post_update.dpl" method="post">
            
            <div class="colm-form">
                <div class="form-container" align="center">
                    <table width="353" border="1">
                      <tr>
                        <td width="121"><span class="style1">Courier/Speed Post Docket Number </span></td>
                        <td width="216"><input type="text" name="post_info" id="post_info" ></td>
                      </tr>

...
public class ListReceipt extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query="select emp_no,emp_name,application_no,to_char(application_date,'dd-mm-yyyy hh24:mi') application_date,applicant_name||' , '||relationship as applicant from eps_option where courier_info is not null order by receipt_date ";
